...
class RemoveDifficultQuestionsWebServiceIT extends SpockTest {
    ...
    def "student removes difficult questions"() {
        ...
        and: "question is removed"
        def difficultQuestionTest = difficultQuestionRepository.findAll().get(0)
        difficultQuestionTest.getDashboard().getId() == dashboard.getId()
        difficultQuestionTest.isRemoved()
        difficultQuestionTest.getRemovedDate() != null

        and: "question still exists in the database"
